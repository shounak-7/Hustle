...
- **Customer Marketplace**: `http://localhost:5001/` or `http://localhost:5001/index.html`
- **Customer Dashboard**: `http://localhost:5001/customer-dashboard.html`
- **Worker Partner Portal**: `http://localhost:5001/worker-dashboard.html`
- **Operations Admin Portal**: `http://localhost:5001/admin`
- **Authentication**: `http://localhost:5001/auth.html`
- **Staff Admin Credentials**:
  - Configured privately via `ADMIN_EMAIL` and `ADMIN_PASSWORD` in `.env` (manual entry on each session).
